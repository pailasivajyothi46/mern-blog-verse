    ...
    return (
        <div className="flex items-center flex-col mt-10 gap-4">
            ...
            <form className="flex flex-col border-black w-1/3 py-7 items-center gap-5 ">
                <div className=" bg-gray-50 px-10 py-2 w-[90%] flex flex-col text-md">
                    <p className="w-[200] flex flex-col text-md">FULL NAME</p>
                    <input type="text" name="name" className="border rounded-xl focus: outline-none focus:border-fuchsia-500" placeholder="enter your name" />
                </div>
                <div className=" bg-gray-50 px-11 py-4 w-[90%] flex flex-col text-md">
                    <p className="w-[200] flex flex-col text-md">EMAIL</p>
                    <input type="email" name="email" className="border rounded-xl focus: outline-none focus:border-fuchsia-500" placeholder="enter your email" />
                </div>
                <div className=" bg-gray-50 px-10 py-2 w-[90%] flex flex-col text-md">
                    <p className="w-[200] flex flex-col text-md">password</p>
                    <input type="password" name="password" className="border rounded-xl focus: outline-none focus:border-fuchsia-500" placeholder="enter password" />
                </div>
                <div className=" bg-gray-50 px-10 py-2 w-[90%] flex flex-col text-md">
                    <p className="w-[200] flex flex-col text-md">conform your password</p>
                    <input type="password" name="re enter" className="border rounded-xl focus: outline-none focus:border-fuchsia-500" placeholder="re enter your password" />
                </div>
                ...
                <button className="text-gray-700 font-semibold  w-[90%] rounded-1 cursor-pointer text-center hover:bg-red-400 ">back to home</button>
            </form>
