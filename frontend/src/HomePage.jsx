...
const HomePage = () => {
    ...
    return (
        <div>
            <NavBar />
            <div className="flex flex-col items-center  justify-around grid-rows-3 mt-5 gap-1">
                <h1 className="font-bold text-2xl">Welcome To BlogVerse</h1>
                <p className="">Discover amazing stories, insights, and ideas from our community of writers.Sign in to create your own posts and save your favorites. </p>
                        ...
                        posts.map((post) => (
                            <div className="w-96 bg-white shadow-lg rounded-lg" key={post.id}>
                                <div className="relative">
                                    <img className=" rounded-t-lg  shadow-lg h-53 w-97 " src={post.Image} alt="Writing" />
                                    <button className="p-3 text-sm  bg-blue-100 rounded-full absolute cursor-pointer right-4 top-3">Save</button>
                                </div>
